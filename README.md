This  code is for an interactive proof protocol, where one party (Cyprian) proves to another party (Alex) that they know the square root of a number modulo n without revealing the square root itself. 
